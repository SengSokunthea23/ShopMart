...
import { Store, Users, Shield, Truck, CreditCard, Headphones, Award, Globe, Clock, Star, CheckCircle, Heart, Target, Zap } from 'lucide-react'
...
export default function AboutPage() {
  const features = [
    {
      ...
      description: 'SSL encryption and secure payment processing for your safety'
    },
    {
      icon: Truck,
      title: 'Fast Delivery',
  ...
  const categories = [
    { name: 'Electronics', count: '2,500+', description: 'Latest gadgets and tech devices' },
    { name: 'Clothing', count: '3,200+', description: 'Fashion for every style and occasion' },
    { name: 'Books', count: '1,800+', description: 'Knowledge and entertainment for all ages' },
    { name: 'Home & Garden', count: '2,100+', description: 'Everything to make your house a home' },
    { name: 'Sports', count: '1,400+', description: 'Fitness and sports equipment for active lifestyles' }
  ]
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="bg-gradient-to-r from-blue-600 to-purple-600 text-white py-20">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-8 max-w-3xl mx-auto">
            Your trusted online marketplace for quality products, exceptional service, 
            and unbeatable prices. We've been serving customers worldwide since 2020.
          </p>
      ...
      <main className="container mx-auto px-4 py-12">
            ...
            <Card>
              ...
              <CardContent>
                <p className="text-gray-600 leading-relaxed">
                  ...
                  while delivering exceptional customer service and creating a seamless online 
            ...
            <Card>
              ...
              <CardContent>
                <p className="text-gray-600 leading-relaxed">
                  ...
                  backed by outstanding service and innovation.
                </p>
              </CardContent>
            </Card>
          </div>
        ...
        {/* Statistics */}
        <section className="mb-16">
          <h2 className="text-3xl font-bold text-center mb-12">ShopMart by the Numbers</h2>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
                <div>
                  <p className="text-gray-600 mb-4">
                    Founded in 2020 by a team of passionate entrepreneurs, ShopMart began as a small 
                    startup with a big vision: to revolutionize online shopping by putting customers first.
                  </p>
                  <p className="text-gray-600 mb-4">
                    What started as a simple idea has grown into a thriving marketplace serving customers 
                    across the globe. We've built our reputation on three core principles: quality products, 
                  ...
                  <p className="text-gray-600 mb-6">
                    ...
                    working with trusted suppliers and brands to ensure every purchase meets our 
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex items-start">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600">Protecting your data and transactions</p>
                      </div>
                    </div>
                    <div className="flex items-start">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600">Putting your satisfaction first, always</p>
                      </div>
                    </div>
                  </div>
                </div>
