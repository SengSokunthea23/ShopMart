...
export const products: Product[] = [
  ...
  },
  {
    ...
    description: 'Timeless straight-fit denim jeans made from premium denim fabric.',
    price: 79.99,
  ...
  },
  {
    id: '17',
    name: 'Winter Jacket',
    description: 'Warm and stylish winter jacket with water-resistant coating and insulated lining.',
    price: 149.99,
  ...
  },
  {
    id: '20',
    name: 'Business Shirt',
    description: 'Professional dress shirt made from wrinkle-resistant fabric, perfect for office wear.',
    price: 69.99,
  ...
  },
  {
    ...
    description: 'Master React development with this comprehensive handbook covering hooks, context, and more.',
    price: 59.99,
  ...
  },
  {
    ...
    description: 'Learn data science with Python including pandas, numpy, and machine learning libraries.',
    price: 54.99,
  ...
  },
  {
    ...
    description: 'Complete guide to modern web design principles, UX/UI, and responsive design.',
    price: 44.99,
  ...
  // Home & Garden
  {
    ...
    description: 'Beautiful set of 3 low-maintenance indoor plants perfect for home decoration.',
    price: 89.99,
  ...
  },
  {
    ...
    description: 'Elegant set of 4 ceramic coffee mugs with modern design and comfortable handles.',
    price: 39.99,
  ...
  },
  {
    ...
    description: 'Professional 8-piece kitchen knife set with wooden block and sharpening steel.',
    price: 129.99,
  ...
  },
  {
    id: '29',
    name: 'Air Purifier',
    description: 'HEPA air purifier with smart sensors and app control for rooms up to 500 sq ft.',
    price: 199.99,
  ...
  // Sports
  {
    ...
    description: 'High-performance tennis racket used by professionals, lightweight with excellent control.',
    price: 159.99,
  ...
  },
  {
    ...
    description: 'Complete resistance band set with 5 bands, handles, door anchor, and workout guide.',
    price: 29.99,
